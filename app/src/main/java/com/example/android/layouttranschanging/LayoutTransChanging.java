    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                container.addView(new GuffyView(context), 1);
            }
        });
...
//        });
    ...
    class GuffyView extends View {
        private LayoutParams defaultLayoutParams = new LayoutParams(
                100, 500);
        private LayoutParams expandedLayoutParams = new LayoutParams(
                500, 500);

        boolean isExpanded = false;

        public GuffyView(Context context) {
            super(context);
            ...
            setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (isExpanded == false) {
                        setLayoutParams(expandedLayoutParams);
                        isExpanded = true;
                    } else {
                        setLayoutParams(defaultLayoutParams);
                        isExpanded = false;
